...
For example, [Remove Space Before or After Characters](https://github.com/platers/obsidian-linter/blob/master/src/rules/remove-space-before-or-after-characters.ts)
...
[Remove Multiple Spaces](https://github.com/platers/obsidian-linter/blob/master/src/rules/remove-multiple-spaces.ts)
...
[protected-ranges.ts](https://github.com/platers/obsidian-linter/blob/master/src/utils/protected-ranges.ts)
...
[Consecutive Blank Lines](https://github.com/platers/obsidian-linter/blob/master/src/rules/consecutive-blank-lines.ts)
is an example.
