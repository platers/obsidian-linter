  ...
  'tabs': {
    ...
    'general': {
      ...
      'lint-on-save': {
        name: 'Lint on save',
        description:
          'Lint the file on manual save (when `Ctrl + S` is pressed or when `:w` is executed while using vim keybindings)',
      },
      'display-message': {
      ...
      'lint-on-file-change': {
        ...
        description:
          'When the a file is closed or a new file is swapped to, the previous file is linted.',
      },
    ...
    'debug': {
      ...
      'log-collection': {
        ...
        description:
          'Goes ahead and collects logs when you `Lint on save` and linting the current file. These logs can be helpful for debugging and create bug reports.',
      },
      'linter-logs': {
        name: 'Linter Logs',
        description:
          'The logs from the last `Lint on save` or the last lint current file run if enabled.',
      },
    },
  },
  ...
  'rules': {
    ...
    'default-language-for-code-fences': {
      ...
      'default-language': {
        ...
        description:
          'Leave empty to do nothing. Languages tags can be found [here](https://prismjs.com/#supported-languages).',
      },
    },
    // emphasis-style.ts
    'emphasis-style': {
    ...
    'format-yaml-array': {
      ...
      'alias-key': {
        ...
        description:
          'Turns on formatting for the YAML aliases section. You should not enable this option alongside the rule `YAML Title Alias` as they may not work well together or they may have different format styles selected causing unexpected results.',
      },
      'tag-key': {
      ...
      'default-array-style': {
        ...
        description:
          'The style of other YAML arrays that are not `tags`, `aliases` or  in `Force key values to be single-line arrays` and `Force key values to be multi-line arrays`',
      },
      'default-array-keys': {
    ...
    'remove-space-before-or-after-characters': {
      ...
      'characters-to-remove-space-before': {
        ...
        description:
          'Removes space before the specified characters. **Note: using `{` or `}` in the list of characters will unexpectedly affect files as it is used in the ignore syntax behind the scenes.**',
      },
      'characters-to-remove-space-after': {
        name: 'Remove Space After Characters',
        description:
          'Removes space after the specified characters. **Note: using `{` or `}` in the list of characters will unexpectedly affect files as it is used in the ignore syntax behind the scenes.**',
      },
    },
    ...
    'space-between-chinese-japanese-or-korean-and-english-or-numbers': {
      ...
      'english-symbols-punctuation-before': {
        ...
        description:
          'The list of non-letter punctuation and symbols to consider to be from English when found before Chinese, Japanese, or Korean characters. **Note: "*" is always considered to be English and is necessary for handling some markdown syntaxes properly.**',
      },
      'english-symbols-punctuation-after': {
        name: 'English Punctuations and Symbols After CJK',
        description:
          'The list of non-letter punctuation and symbols to consider to be from English when found after Chinese, Japanese, or Korean characters. **Note: "*" is always considered to be English and is necessary for handling some markdown syntaxes properly.**',
      },
    },
    // strong-style.ts
    'strong-style': {
    ...
    'yaml-timestamp': {
      ...
      'format': {
        name: 'Format',
        description:
          'Moment date format to use (see [Moment format options](https://momentjscom.readthedocs.io/en/latest/moment/04-displaying/01-format/))',
      },
      'convert-to-utc': {
