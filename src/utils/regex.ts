...
// export const simpleURIRegex = /(?:(?:[a-z\-0-9]+:)\/{2})(?:[^\s/?#]*)(?:(?:[/?#][^\s")']*[^\s")'.?!])|[/])?/gi;
export const simpleURIRegex = /(([a-z\-0-9]+:)\/{2})([^\s/?#]*[^\s"\)'.?!/]|[/])?(([/?#][^\s"\)']*[^\s"\)'.?!])|[/])?/gi;
...
// export const urlRegex = urlRegexSafe({strict: false, re2: false, tlds: ['obsidian']});
// console.log(urlRegexSafe({strict: true, re2: false, ipv4: false, ipv6: false, localhost: false}).source);
